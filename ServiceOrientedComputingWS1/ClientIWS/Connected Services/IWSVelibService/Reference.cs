...
namespace ClientIWS.IWSVelibService {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="Position", Namespace="http://schemas.datacontract.org/2004/07/SOAPLibraryVelib")]
    [System.SerializableAttribute()]
    ...
    public interface IService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/GetInformations", ReplyAction="http://tempuri.org/IService/GetInformationsResponse")]
        System.Threading.Tasks.Task<string> GetInformationsAsync(int stationNumber, string city);
    }
    ...
    public partial class ServiceClient : System.ServiceModel.ClientBase<ClientIWS.IWSVelibService.IService>, ClientIWS.IWSVelibService.IService {
        ...
        public string GetInformations(int stationNumber, string city) {
            return base.Channel.GetInformations(stationNumber, city);
        }
        
        public System.Threading.Tasks.Task<string> GetInformationsAsync(int stationNumber, string city) {
            return base.Channel.GetInformationsAsync(stationNumber, city);
        }
    }
}
